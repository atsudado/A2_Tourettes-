// ============================================================
// LEVEL 1 DATA — five stages/checkpoints (L1-1 through L1-5).
// This file only defines LEVEL_1_STAGES (pure data). The shared
// engine logic that turns stage data into a playable world
// (buildWorld(), the WORLD registry, setActiveLevel()) lives in
// levels.js — load this file BEFORE levels.js in index.html.
// ============================================================
// ============================================================
